...
model = dict(
        ...
        width_multiple=0.50,
        backbone=dict(
                type='EfficientRep', #这里就会变成使用：from yolov6.models.efficientrep import EfficientRep 默认这样写：from yolov6.models.efficientrep import EfficientRep
        ...
        neck=dict(
                type='RepGDNeck', #from gold_yolo.reppan import RepGDNeck 默认这样写：from gold_yolo.reppan import *
